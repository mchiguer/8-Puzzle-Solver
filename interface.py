...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.algorithmbox.configure(cursor="hand2", state="readonly",
                                    values=('BFS', 'DFS (Graph Search)', 'DFS (Backtracking)', 
                                            'Voraz (Manhattan)', 'ID', 'A* Manhattan', 'A* Euclidean', 
                                            'IDA* Manhattan', 'A* Misplaced Tiles','A* Sequences', 'A* Rows Columns'))
    ...
    def solveState():
        ...
        if str(algorithm) == 'BFS':
            ...
            path, cost, counter, depth, runtime, nodes, max_stored = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_node_stored
        elif str(algorithm) == 'A* Misplaced Tiles':
            main.graphSearch(initialState,main.function_1,main.getMisplacedTiles)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'A* Sequences' :
            main.graphSearch(initialState,main.function_1,main.getSequences)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'A* Rows Columns' :
            main.graphSearch(initialState,main.function_1,main.getRowsColumns)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
